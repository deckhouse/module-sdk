...
//go:generate minimock -i github.com/deckhouse/module-sdk/pkg.MetricsCollector -o metrics_collector_mock.go -n MetricsCollectorMock -p mock
...
// MetricsCollectorMock implements mm_pkg.MetricsCollector
...
// NewMetricsCollectorMock returns a mock for mm_pkg.MetricsCollector
...
// MetricsCollectorMockAddExpectation specifies expectation struct of the MetricsCollector.Add
...
// MetricsCollectorMockAddParams contains parameters of the MetricsCollector.Add
...
// ExpectNameParam1 sets up expected param name for MetricsCollector.Add
...
// ExpectValueParam2 sets up expected param value for MetricsCollector.Add
...
// ExpectLabelsParam3 sets up expected param labels for MetricsCollector.Add
...
// Return sets up results that will be returned by MetricsCollector.Add
...
func (mmAdd *mMetricsCollectorMockAdd) Set(f func(name string, value float64, labels map[string]string, opts ...mm_pkg.Option)) *MetricsCollectorMock {
	...
	if len(mmAdd.expectations) > 0 {
		mmAdd.mock.t.Fatalf("Some expectations are already set for the MetricsCollector.Add method")
	}
...
// Then sets up MetricsCollector.Add return parameters for the expectation previously defined by the When method
func (e *MetricsCollectorMockAddExpectation) Then() *MetricsCollectorMock {
	return e.mock
}

// Times sets number of times MetricsCollector.Add should be invoked
...
// MetricsCollectorMockExpireExpectation specifies expectation struct of the MetricsCollector.Expire
...
// MetricsCollectorMockExpireParams contains parameters of the MetricsCollector.Expire
type MetricsCollectorMockExpireParams struct {
	group string
}

// MetricsCollectorMockExpireParamPtrs contains pointers to parameters of the MetricsCollector.Expire
type MetricsCollectorMockExpireParamPtrs struct {
	group *string
}

// MetricsCollectorMockExpireOrigins contains origins of expectations of the MetricsCollector.Expire
...
// Expect sets up expected params for MetricsCollector.Expire
...
// ExpectGroupParam1 sets up expected param group for MetricsCollector.Expire
...
// Inspect accepts an inspector function that has same arguments as the MetricsCollector.Expire
...
// Return sets up results that will be returned by MetricsCollector.Expire
...
// Set uses given function f to mock the MetricsCollector.Expire method
func (mmExpire *mMetricsCollectorMockExpire) Set(f func(group string)) *MetricsCollectorMock {
	if mmExpire.defaultExpectation != nil {
		mmExpire.mock.t.Fatalf("Default expectation is already set for the MetricsCollector.Expire method")
	}

	if len(mmExpire.expectations) > 0 {
		mmExpire.mock.t.Fatalf("Some expectations are already set for the MetricsCollector.Expire method")
	}
...
// When sets expectation for the MetricsCollector.Expire which will trigger the result defined by the following
// Then helper
...
// Then sets up MetricsCollector.Expire return parameters for the expectation previously defined by the When method
func (e *MetricsCollectorMockExpireExpectation) Then() *MetricsCollectorMock {
	return e.mock
}

// Times sets number of times MetricsCollector.Expire should be invoked
...
// Expire implements mm_pkg.MetricsCollector
...
// MetricsCollectorMockIncExpectation specifies expectation struct of the MetricsCollector.Inc
...
// MetricsCollectorMockIncParams contains parameters of the MetricsCollector.Inc
...
// ExpectNameParam1 sets up expected param name for MetricsCollector.Inc
...
// ExpectLabelsParam2 sets up expected param labels for MetricsCollector.Inc
...
// Return sets up results that will be returned by MetricsCollector.Inc
...
func (mmInc *mMetricsCollectorMockInc) Set(f func(name string, labels map[string]string, opts ...mm_pkg.Option)) *MetricsCollectorMock {
	...
	if len(mmInc.expectations) > 0 {
		mmInc.mock.t.Fatalf("Some expectations are already set for the MetricsCollector.Inc method")
	}
...
// Then sets up MetricsCollector.Inc return parameters for the expectation previously defined by the When method
func (e *MetricsCollectorMockIncExpectation) Then() *MetricsCollectorMock {
	return e.mock
}

// Times sets number of times MetricsCollector.Inc should be invoked
...
// MetricsCollectorMockSetExpectation specifies expectation struct of the MetricsCollector.Set
...
// MetricsCollectorMockSetParams contains parameters of the MetricsCollector.Set
...
// ExpectNameParam1 sets up expected param name for MetricsCollector.Set
...
// ExpectValueParam2 sets up expected param value for MetricsCollector.Set
...
// ExpectLabelsParam3 sets up expected param labels for MetricsCollector.Set
...
// Return sets up results that will be returned by MetricsCollector.Set
...
func (mmSet *mMetricsCollectorMockSet) Set(f func(name string, value float64, labels map[string]string, opts ...mm_pkg.Option)) *MetricsCollectorMock {
	...
	if len(mmSet.expectations) > 0 {
		mmSet.mock.t.Fatalf("Some expectations are already set for the MetricsCollector.Set method")
	}
...
// Then sets up MetricsCollector.Set return parameters for the expectation previously defined by the When method
func (e *MetricsCollectorMockSetExpectation) Then() *MetricsCollectorMock {
	return e.mock
}

// Times sets number of times MetricsCollector.Set should be invoked
...
// MetricsCollectorMockWriteOutputExpectation specifies expectation struct of the MetricsCollector.WriteOutput
...
// MetricsCollectorMockWriteOutputParams contains parameters of the MetricsCollector.WriteOutput
type MetricsCollectorMockWriteOutputParams struct {
	writer io.Writer
}

// MetricsCollectorMockWriteOutputParamPtrs contains pointers to parameters of the MetricsCollector.WriteOutput
type MetricsCollectorMockWriteOutputParamPtrs struct {
	writer *io.Writer
}

// MetricsCollectorMockWriteOutputResults contains results of the MetricsCollector.WriteOutput
type MetricsCollectorMockWriteOutputResults struct {
	err error
}

// MetricsCollectorMockWriteOutputOrigins contains origins of expectations of the MetricsCollector.WriteOutput
...
// Expect sets up expected params for MetricsCollector.WriteOutput
...
// ExpectWriterParam1 sets up expected param writer for MetricsCollector.WriteOutput
...
// Inspect accepts an inspector function that has same arguments as the MetricsCollector.WriteOutput
...
// Return sets up results that will be returned by MetricsCollector.WriteOutput
...
// Set uses given function f to mock the MetricsCollector.WriteOutput method
func (mmWriteOutput *mMetricsCollectorMockWriteOutput) Set(f func(writer io.Writer) (err error)) *MetricsCollectorMock {
	if mmWriteOutput.defaultExpectation != nil {
		mmWriteOutput.mock.t.Fatalf("Default expectation is already set for the MetricsCollector.WriteOutput method")
	}

	if len(mmWriteOutput.expectations) > 0 {
		mmWriteOutput.mock.t.Fatalf("Some expectations are already set for the MetricsCollector.WriteOutput method")
	}
...
// When sets expectation for the MetricsCollector.WriteOutput which will trigger the result defined by the following
// Then helper
...
// Then sets up MetricsCollector.WriteOutput return parameters for the expectation previously defined by the When method
...
// Times sets number of times MetricsCollector.WriteOutput should be invoked
...
// WriteOutput implements mm_pkg.MetricsCollector
