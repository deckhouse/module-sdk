...
func NewObjectPatchCollector() *ObjectPatchCollector {
	return &ObjectPatchCollector{
		dataStorage: make([]map[string]interface{}, 0),
	}
}

func (c *ObjectPatchCollector) collect(payload map[string]interface{}) {
...
func (c *ObjectPatchCollector) create(operation CreateOperation, obj *unstructured.Unstructured) {
	c.collect(map[string]interface{}{"operation": operation, "object": obj})
}
...
func (c *ObjectPatchCollector) JQPatch(kind, apiVersion, name, namespace string, filter string, subresource string, ignoreMissingObjects bool) {
	c.patch(JQPatch, kind, apiVersion, name, namespace, filter, subresource, false)
}

func (c *ObjectPatchCollector) MergePatch(kind, apiVersion, name, namespace string, patch interface{}, subresource string, ignoreMissingObjects bool) {
	c.patch(MergePatch, kind, apiVersion, name, namespace, patch, subresource, ignoreMissingObjects)
}

func (c *ObjectPatchCollector) JSONPatch(kind, apiVersion, name, namespace string, patch []interface{}, subresource string, ignoreMissingObjects bool) {
	c.patch(JSONPatch, kind, apiVersion, name, namespace, patch, subresource, ignoreMissingObjects)
}

func (c *ObjectPatchCollector) patch(operation PatchOperation, kind, apiVersion, name, namespace string, patch interface{}, subresource string, ignoreMissingObjects bool) {
	ret := map[string]interface{}{
		"operation": operation,
		"kind":      kind,
		"name":      name,
